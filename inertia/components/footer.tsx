    ...
    <footer className="bg-red-100 text-red-800 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-black">
              Jalan Tembusan Strat 2, Kelurahan Gunung Samarinda, Balikpapan Utara
            </p>
            <p className="text-sm font-bold pt-2">No. HP</p>
            <p className="text-sm text-black">+62 821 XXXX XXXX</p>
            <p className="text-sm font-bold pt-2">Email</p>
            <p className="text-sm text-black">fokus@gmail.com</p>
          </div>
          <div>
            ...
            <div className="pt-2">
              <a
                href="https://www.youtube.com/@yayasan.fokus"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-400 hover:text-white"
              >
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0">&copy; 2024 Yayasan FOKUS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
